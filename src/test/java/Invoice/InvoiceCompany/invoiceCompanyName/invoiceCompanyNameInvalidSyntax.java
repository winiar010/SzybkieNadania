...
public class invoiceCompanyNameInvalidSyntax extends Base {
    ...
    public void shouldReturnInvalidSyntax() throws InterruptedException {
        ...
        formPageValidation.inputInvoiceCompanyNameInvalidSyntax();
        formPageValidation.clickZgoda();
        Assert.assertEquals("POLE ZAWIERA NIEDOZWOLONE ZNAKI", formPageValidation.getError());
    }
}
