...
public class receiverPhoneInvalid extends Base {
    ...
    public void shouldReturnFieldRequired() throws InterruptedException {
        ...
        formPage.clickA();
        formPageValidation.inputReceiverPhoneInvalid();
        formPageValidation.clickReceiverEmail();
        Assert.assertEquals("NIEPRAWIDŁOWY NUMER TELEFONU", formPageValidation.getReceiverPhoneError());
    }
}
