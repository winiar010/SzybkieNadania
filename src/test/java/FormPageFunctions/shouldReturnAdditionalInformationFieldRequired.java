...
public class shouldReturnAdditionalInformationFieldRequired extends Base {
    ...
    public void shouldOpenAdditionalInformation() throws InterruptedException {
        ...
        formPageValidation.clickCustomerReference();
        formPageValidation.clickSenderName();
        Assert.assertEquals("POLE WYMAGANE", formPageValidation.getAdditionalInformationError());
    }
}