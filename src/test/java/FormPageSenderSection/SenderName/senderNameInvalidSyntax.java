...
public class senderNameInvalidSyntax extends Base {
    ...
    public void shouldReturnInvalidSyntax() throws InterruptedException {
        ...
        formPage.clickA();
        formPageValidation.inputSenderNameInvalidSyntax();
        formPageValidation.clickSenderEmail();
        Assert.assertEquals("POLE ZAWIERA NIEDOZWOLONE ZNAKI", formPageValidation.getSenderNameError());
    }
}
