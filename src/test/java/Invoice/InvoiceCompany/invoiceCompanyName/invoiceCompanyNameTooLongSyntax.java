...
public class invoiceCompanyNameTooLongSyntax extends Base {
    ...
    public void shouldReturnTooLongSyntax() throws InterruptedException {
        ...
        formPageValidation.inputInvoiceCompanyNameTooLongSyntax();
        formPageValidation.clickSenderEmail();
        Assert.assertEquals("TA WARTOŚĆ JEST ZBYT DŁUGA. POWINNA MIEĆ 250 ZNAKÓW LUB MNIEJ", formPageValidation.getError());
    }
}
